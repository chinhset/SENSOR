...
#if defined(USE_DEBUG) || defined(USE_CONTROL_PUMP) || defined(USE_CONTROL_ALARM) || defined(USE_MINI_RADAR) || defined(USE_PTC06)
    #include "console.h"
#endif
...
void Initphoto(void){
    DelayMs(2500);
    //thiet lap lai size image
    sendPhotoSize();
    //thiet lap lai ti so nen image
    sendCompressRate();
   }
/********************/
